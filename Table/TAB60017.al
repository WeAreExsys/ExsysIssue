table 60017 "Change Request Header"
{
    ...
    fields
    {
        field(1;"No.";Code[20])
        {
            ...
            begin
                ...
                if "No." <> xRec."No." then begin
                  MgtSetup.GET;
                  NoSeriesMgt.TestManual(MgtSetup."Change Request Nos.");
                  "No. Series" := '';
                end;
                //+
            end;
        ...
        field(3;Type;Option)
        {
            OptionMembers = Implement,Maintenance,"Chargable Service",Other,"MA Ref.";
        ...
        {
            FieldClass = Normal;
            TableRelation = "Maintenance Agreement"."No." WHERE ("Project No."=FIELD("Project No."),
                                                                 Status=CONST(Active));
        }
        ...
        field(50003;"Areas Affected";Text[100])
        {
        }
        field(50004;"Billing Required";Boolean)
        {
        }
        field(50005;"Billine Comment";Text[30])
        {
            Description = 'Exsys-CS';
        }
        field(50006;"Issue No.";Code[20])
        {
            Description = 'Exsys-Golf';
            Editable = false;
        }
        field(50007;"Created to Issue";Boolean)
        {
            Editable = false;
        }
    }
    ...
    begin
        ...
        Type := Type::"Chargable Service";
        //+
    end;

    var
        IssueHeader : Record "Change Request Header";
    ...
    procedure AssistEdit(OldIssueHeader : Record "Change Request Header") : Boolean;
    var
        IssueHeader2 : Record "Change Request Header";
    begin
        //Exsys-Wichit 160615
        with IssueHeader do begin
          ...
          MgtSetup.GET;
          MgtSetup.TESTFIELD("Change Request Nos.");
          if NoSeriesMgt.SelectSeries(MgtSetup."Change Request Nos.",OldIssueHeader."No. Series","No. Series") then begin
    ...
    begin
        //Exsys-Golf
        MgtSetup.GET;
        exit(MgtSetup."Change Request Nos.");
        //*
    end;
